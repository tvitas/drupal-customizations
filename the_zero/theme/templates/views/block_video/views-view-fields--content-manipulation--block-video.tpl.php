...
<source src="<?php print $view -> render_field('field_file', $view -> row_index);?>">
</video>
<div id="video-slide-show-block">
<div class="uk-overlay-panel uk-overlay-background uk-flex uk-flex-center uk-flex-middle">
<div class="slide-text-wrapper uk-text-center">
...
<p class="uk-margin-top"><button class="uk-button uk-button-large<?php echo $button_class;?>"><?php echo _t('_learn_more_', 'Sužinokite daugiau');?></button></p>
<?php endif;?>
</div>
</div>
</div>
