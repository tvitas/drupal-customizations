...
<div id="child-terms-dropdown" data-uk-sticky="{top:41, animation: 'uk-animation-slide-top'}" style="z-index: 999;">
...
<div id="page-title" data-uk-sticky="{top:41, animation: 'uk-animation-slide-top'}" style="z-index: 998; max-height: 40px;">
