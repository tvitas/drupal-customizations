...
<?php hide($content['display_price']);?>
<?php hide($content['field_old_price']);?>
<?php hide($content['add_to_cart']);?>
<?php hide($content['field_image']); ?>
<?php hide($content['field_file']); ?>
<?php hide($content['field_specifications']); ?>
...
<?php if(!isset($content['field_image'][0]['#item'])):?>
<ul class="uk-list">
<li>
<div class="cover-box-full">
...
<?php endif;?>
<div class="in-stock"><p><?php print $stock_level; ?></p></div>
<?php print render($content['add_to_cart']);?>
<ul class="uk-tab" data-uk-tab="{connect:'#tab-content'}">
<li><a href="#"><?php echo _t('_product_specs_', 'Prekės specifikacija')?></a></li>
<li><a href="#"><?php echo _t('_product_', 'Prekė')?></a></li>
</ul>
