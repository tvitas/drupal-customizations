...
<h6><?php print render($content['field_author']);?></h6>
<h5><a href="<?php print $node_url; ?>"><?php print $node_title;?></a></h5>
<h6><?php print render($content['field_published']);?></h6>
...
<a id="call-contact-form-<?php echo $node->nid;?>" href="#contact-form" class="uk-button uk-button-primary uk-button-large" data-uk-modal="{center:true}" data-form-subject="<?php echo $content['full_product_title'] . ' ' . strtolower(_t('_order_', 'Užsakymas'));?>"><i class="fa fa-check-square-o fa-lg" aria-hidden="true"></i>&nbsp;<?php print _t('_order_product_', 'Užsakyti');?></a>
</div>
</div>
<?php endif; ?>
</div>
