...
class WebToPay {
    ...
    public static function getRequestSpec() {
        ...
        return array(
                array('projectid',      11,     true,   true,   true,   ''),
                array('orderid',        40,     true,   true,   true,   ''),
                array('lang',           3,      false,  true,   true,   '/^[a-z]{3}$/i'),
//                array('amount',         11,     false,  true,   true,   '/^\d+\.\d+$/'),
                array('amount',         11,     false,  true,   true,   '/^[0-9]{1,7}(\.[0-9]{1,2})?$/'),
